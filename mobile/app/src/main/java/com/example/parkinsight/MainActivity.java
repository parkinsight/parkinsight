...
//        String password = "password";
        ...
        if(TextUtils.isEmpty(username) || TextUtils.isEmpty(password)) {
            Toast.makeText(MainActivity.this, "enter an email and password" + username, Toast.LENGTH_LONG).show();
...
//                                responseView.setText("hopefully auth: " + hopefullyAuth);
                                ...
                                Toast.makeText(MainActivity.this, "hmm.. there was an error", Toast.LENGTH_LONG).show();
                            }
                        }
